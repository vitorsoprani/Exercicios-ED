...
int main() {
    ...
    //--------------------------------------------------------------
    //Tenta enviar o pedido de Patricia, porem, ela tem restricao calorica de 600
    ...
    //-----------------------------------------------------
    //Agora, Patricia vai tentar tirar os produtos do seu pedido para que este seja enviado
